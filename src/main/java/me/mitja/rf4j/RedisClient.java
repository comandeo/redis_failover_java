...
/**
 * The content of this file was copied from Command interface
 * implemented in jedis package
...
public interface RedisClient {
    ...
    public void linsert(final String key, final BinaryClient.LIST_POSITION where,
